                    ...
                    <div class="card-body">
                        ...
                        <div class="filter">
                            ...
                            @endphp
                              ...
                              <li><a class="dropdown-item" href="/rpinjam">Reset</a></li>
                              @foreach($majors as $major)
                                <li><a class="dropdown-item" href="/rpinjam?{{ $tempmonth.$tempyear }}major={{ $major->id }}">{{ $major->major }}</a></li>
                              @endforeach
                            </ul>
                        </div>
                       ...
                       <div class="mb-3 col-md-12">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <form method="POST" action="/rpinjam/{{ $majr }}/{{ $month }}/{{ $yer }}" class="form-control blok" enctype="multipart/form-data">
                                            @csrf
                                            <div class="d-flex justify-content-end">
                                                <button type="submit" class="btn btn-success"><i class="bi bi-file-excel"></i> Eksport</button>&nbsp;&nbsp;
                                                <a href="/rpinjam/{{ $majr }}/{{ $month }}/{{ $yer }}" class="btn btn-primary" target="_blank"><i class="bi bi-printer"></i> Cetak</a>
                                            </div>
                                        </form>
                                    </td>
                                </tr>
