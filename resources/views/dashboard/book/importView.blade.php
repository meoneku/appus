            ...
            <div class="col-xxl-12 col-xl-12">
                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        ...
                        <form action="/import/importbuku" method="post" class='form-control' enctype="multipart/form-data">
                            @csrf
                            <div class="input-group">
                                <input type="hidden" name="file" value="{{ $file }}">
                                <input type="file" name="none" class="form-control" disabled required>
                                <a href="/buku" class="btn btn-warning" ><i class="bi bi-arrow-left-circle"></i> Kembali</a>
                        ...
                        <table class="table table-sm mt-3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $rows[$i]['no'] }}</td>
                                    <td>{{ $rows[$i]['judul'] }}</td>
                                    <td>{{ $categories->where('id', $rows[$i]['kategori'])->first()->category }}</td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
