            ...
            <div class="col-xxl-12 col-xl-12">
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/buku" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="row mb-3">
                                <label for="title" class="col-sm-4 col-form-label">Judul Buku</label>
                                <div class="col-sm-8">
                                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" maxlength="200" required autofocus>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="isbn" class="col-sm-4 col-form-label">ISBN</label>
                                <div class="col-sm-4">
                                    <input type="number" name="isbn" id="isbn" class="form-control @error('isbn') is-invalid @enderror" value="{{ old('isbn') }}" maxlength="20" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="book_number" class="col-sm-4 col-form-label">Nomor Buku</label>
                                <div class="col-sm-4">
                                    <input type="number" name="book_number" id="book_number" class="form-control @error('book_number') is-invalid @enderror" value="{{ old('book_number') }}" maxlength="20" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="author" id="author" class="form-control @error('author') is-invalid @enderror" value="{{ old('author') }}" maxlength="128" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="publisher" class="col-sm-4 col-form-label">Penerbit</label>
                                <div class="col-sm-6">
                                    <input type="text" name="publisher" id="publisher" class="form-control @error('publisher') is-invalid @enderror" value="{{ old('publisher') }}" maxlength="128" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="public_year" class="col-sm-4 col-form-label">Tahun Terbit</label>
                                <div class="col-sm-2">
                                    <input type="text" name="public_year" id="public_year" class="form-control @error('public_year') is-invalid @enderror" value="{{ old('public_year') }}" maxlength="4" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="stock" class="col-sm-4 col-form-label">Jumlah</label>
                                <div class="col-sm-2">
                                    <input type="number" name="stock" id="stock" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock') }}" maxlength="5" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="rack" class="col-sm-4 col-form-label">Tempat Rak</label>
                                <div class="col-sm-3">
                                    <input type="text" name="rack" id="rack" class="form-control @error('rack') is-invalid @enderror" value="{{ old('rack') }}" maxlength="64" required>
                                </div>
                            </div>
                            <div class="row mb-3">
